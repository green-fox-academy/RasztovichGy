...
#define QUEUE_SIZE 1
#define CLIENT_IP           "127.0.0.1" // board's IP
...
int main()
{
	...
	addr_in.sin_addr.s_addr = inet_addr(CLIENT_IP);             // Server IP

	struct sockaddr *addr = (struct sockaddr *)&addr_in;
	// Make a struct sockaddr pointer, which points to the address stucture
